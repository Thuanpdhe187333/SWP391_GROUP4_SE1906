			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                                        ...
                                        <div class="features_items"> <!<!-- feature_item -->
                                                    ...
                                                    <div class="product-image-wrapper">
                                                        <div class="single-products">
                                                            <div class="productinfo text-center">
                                                                <img src="images/products/${p.image}" alt="${p.productName}" />
                                                                <h2>$${p.price}</h2>
                                                                <p>${p.productName}</p>
                                                    ...
                                                    <c:forEach var="p" items="${latestProducts}">
                                                        <div class="col-sm-4">
                                                            <div class="product-image-wrapper">
                                                                <div class="single-products">
                                                                    <div class="productinfo text-center">
                                                                        <img src="${pageContext.request.contextPath}/images/products/${p.image}" alt="${p.productName}" class="img-responsive" />
                                                                        <h2>$${p.price}</h2>
                                                                        <p>${p.productName}</p>
                                                                        <a href="#" class="btn btn-default add-to-cart">
                                                                            <i class="fa fa-shopping-cart"></i> Add to cart
