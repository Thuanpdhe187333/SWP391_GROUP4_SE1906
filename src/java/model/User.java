...
public class User {
    ...
    // Phương thức để set ngày sinh từ chuỗi
    public void setDobFromString(String dobString) {
        try {
            this.dob = sdf.parse(dobString); // Chuyển chuỗi thành đối tượng Date
        } catch (ParseException e) {
            System.err.println("❌ Định dạng ngày sinh không hợp lệ: " + dobString + ". Định dạng mong đợi: yyyy-MM-dd");
            this.dob = null;
        }
    }

    // Phương thức để lấy ngày sinh dưới dạng chuỗi
    public String getDobAsString() {
        return (dob != null) ? sdf.format(dob) : "N/A";
    }

    // Phương thức lấy ngày tạo tài khoản dưới dạng chuỗi
