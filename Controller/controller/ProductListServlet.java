...
public class ProductListServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Product> productList = dao.getAllProduct(); // mặc định load all
